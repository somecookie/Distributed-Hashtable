...
all: clean benchmark pps-launch-server pps-client-get pps-client-put pps-list-nodes pps-client-cat pps-dump-node pps-client-substr pps-client-find
...
benchmark : benchmark.o  $(DEPENDANCIES)
	gcc $(CFLAGS) benchmark.o  $(DEPENDANCIES) -o benchons -lcrypto
